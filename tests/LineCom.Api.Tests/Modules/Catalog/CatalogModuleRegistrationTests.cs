...
public sealed class CatalogModuleRegistrationTests
{
    ...
    [Fact]
    public void AddCatalogModule_RegistersAdminCatalogBrandRepositoryAsScoped()
    {
        var services = new ServiceCollection();
        services.AddCatalogModule();

        var descriptor = Assert.Single(services, service => service.ServiceType == typeof(IAdminCatalogBrandRepository));

        Assert.Equal(ServiceLifetime.Scoped, descriptor.Lifetime);
        Assert.Equal(typeof(DapperAdminCatalogBrandRepository), descriptor.ImplementationType);
    }

    [Fact]
    public void AddCatalogModule_RegistersAdminCatalogBrandServiceAsScoped()
    {
        var services = new ServiceCollection();
        services.AddCatalogModule();

        var descriptor = Assert.Single(services, service => service.ServiceType == typeof(IAdminCatalogBrandService));
    ...
    [Fact]
    public void AddCatalogModule_RegistersAdminCatalogProductRepositoryAsScoped()
    {
        var services = new ServiceCollection();
        services.AddCatalogModule();

        var descriptor = Assert.Single(services, service => service.ServiceType == typeof(IAdminCatalogProductRepository));

        Assert.Equal(ServiceLifetime.Scoped, descriptor.Lifetime);
        Assert.Equal(typeof(DapperAdminCatalogProductRepository), descriptor.ImplementationType);
    }
    ...
    [Fact]
    public void AddCatalogModule_RegistersAdminCatalogImageServiceAsScoped()
    {
        var services = new ServiceCollection();
        services.AddCatalogModule();

        var descriptor = Assert.Single(services, service => service.ServiceType == typeof(IAdminCatalogImageService));

        Assert.Equal(ServiceLifetime.Scoped, descriptor.Lifetime);
        Assert.Equal(typeof(AdminCatalogImageService), descriptor.ImplementationType);
    }
    ...
    public void AddCatalogModule_RegistersAdminCatalogProductServiceAsScoped()
    {
        ...
        var descriptor = Assert.Single(services, service => service.ServiceType == typeof(IAdminCatalogProductService));

        Assert.Equal(ServiceLifetime.Scoped, descriptor.Lifetime);
        Assert.Equal(typeof(AdminCatalogProductService), descriptor.ImplementationType);
    }
