      ...
      <section className="admin-catalog-form admin-product-manager__editor" aria-label="Редактор товара">
        ...
        <form className="admin-product-form" onSubmit={submitProduct}>
          ...
          <section
            ...
            role="tabpanel"
          >
            <p className="admin-catalog-status">Редактор характеристик будет доступен в панели атрибутов товара.</p>
          </section>
          ...
          <section
            ...
            role="tabpanel"
          >
            <p className="admin-catalog-status">Изображения будут управляться отдельной панелью товара.</p>
          </section>
